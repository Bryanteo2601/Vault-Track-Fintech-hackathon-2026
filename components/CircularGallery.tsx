...
class Title {
  ...
  constructor({ gl, plane, renderer, text, textColor = '#E8F1F5', font = '30px sans-serif' }: any) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class App {
  ...
  createMedias(items: any, bend = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: `https://picsum.photos/seed/1/800/600?grayscale`, text: 'Asset 1' },
      { image: `https://picsum.photos/seed/2/800/600?grayscale`, text: 'Asset 2' },
      { image: `https://picsum.photos/seed/3/800/600?grayscale`, text: 'Asset 3' },
      { image: `https://picsum.photos/seed/4/800/600?grayscale`, text: 'Asset 4' },
      { image: `https://picsum.photos/seed/5/800/600?grayscale`, text: 'Asset 5' },
      { image: `https://picsum.photos/seed/6/800/600?grayscale`, text: 'Asset 6' }
    ];
